...
const AboutMe = () => {
  ...
  return (
    <div className={st.container}>
      <h2 ref={heRef}>{pathName === '/ua' ? 'Про мене' : 'About me'}</h2>
      <div>
        <div ref={refLeft}>
          <Swim>
            {pathName === '/ua'
        ...
        <div ref={refRight}>
          <div className={st.icons}>
            ...
            <Swim isFast={true} delay={0.6}>
              <Image
                title={
                  pathName === '/ua' ? 'ElectronJs логотип' : 'ElectronJs Logo'
                }
                src={ElectronJsLogo}
                alt={'ElectronJs'}
                width={40}
            ...
            <Swim isFast={true} delay={0.8}>
              <Image
                title={
                  pathName === '/ua' ? 'JavaScript логотип' : 'JavaScript Logo'
                }
                src={JavaScriptLogo}
                alt={'JavaScript'}
                width={40}
            ...
            <Swim isFast={true} delay={1}>
              <Image
                title={
                  pathName === '/ua' ? 'TypeScript логотип' : 'TypeScript Logo'
                }
                src={TypeScriptLogo}
                alt={'TypeScript'}
                width={40}
            ...
            <Swim isFast={true} delay={1}>
              <Image src={SocketLogo} alt={'Socket'} width={40} height={40} />
            </Swim>
            <Swim isFast={true} delay={0.2}>
              <Image
        ...
        <a
          ...
          ref={refA}
          href={
            'https://drive.google.com/file/d/1Q4PgAvuOPih8iE-Jw0XZxnKMpqCACF-N/view?usp=share_link'
          }
          target="_blank"
          rel="noopener noreferrer"
        >
          {pathName === '/ua' ? 'резюме' : 'resume'}
          <Image
